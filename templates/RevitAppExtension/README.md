...
Use this template when you need an app-style Revit extension with UI, navigation, and service/handler structure.

For implementation details, use these docs:

- App extension architecture and lifecycle:
	https://github.com/AEC-AB/tools-extensions-public/blob/main/docs/dotnet/APP_EXTENSION_DEVELOPER_GUIDE.md
- Revit-specific app guidance:
	https://github.com/AEC-AB/tools-extensions-public/blob/main/docs/dotnet/PLATFORM_GUIDES/REVIT_APP_EXTENSION.md
