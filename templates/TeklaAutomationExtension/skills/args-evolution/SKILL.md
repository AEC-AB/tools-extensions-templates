## name: args-evolution
description: Use this skill when editing `*Args.cs` in the Tekla Automation Extension template
...
- Collector interface: `ITeklaAutoFillCollector<TArgs>`
- Use collectors when values should come from the active model instead of free text.

## Special controls

No Tekla-only special controls are required here. Use shared field attributes and the docs for exact options.
