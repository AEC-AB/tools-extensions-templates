...
public static class WindowHandler
{
    ...
    {
        private readonly global::System.IntPtr _revitMainWindowHandle;
        private readonly global::System.IntPtr _thisHandle;
        private global::System.IntPtr? _lastForegroundWindow;

        public static global::System.IDisposable KeepOnTop(global::System.Windows.Window window, global::System.IntPtr revitMainWindowHandle)
        {
            ...
            var nativeMethods = new NativeMethods(revitMainWindowHandle, hwndSource.Handle);
            return nativeMethods;
        }

        public NativeMethods(global::System.IntPtr revitMainWindowHandle, global::System.IntPtr windowHandle)
        {
            _revitMainWindowHandle = revitMainWindowHandle;
        ...
        private void SetAboveWindow()
        {
            ...
            if (_lastForegroundWindow != _thisHandle && _lastForegroundWindow != _revitMainWindowHandle && foregroundWindow == _revitMainWindowHandle)
            {
                SetForegroundWindow(_thisHandle);
            }
            _lastForegroundWindow = foregroundWindow;

            if (foregroundWindow == _revitMainWindowHandle)
            {
                SetWindowPos();
            }
        }
        ...
        private void SetWindowPos()
        {
            ...
            SetWindowPos(_revitMainWindowHandle, _thisHandle, 0, 0, 0, 0, SWP_NOACTIVATE | SWP_NOMOVE | SWP_NOSIZE);
        }
